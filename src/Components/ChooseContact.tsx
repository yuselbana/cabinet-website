...
const ChooseContact: React.FunctionComponent<ChooseContactProps> = () => {
    return ( 
        <div className=" min-h-screen  pt-[7rem] grid grid-rows-5  place-items-center">
            ...
            <RowComponent button={"Book Now"} buttonHREF={"/book"} order={"1"} title={"Schedule Your Appoinment"} image={contact}  body={"Book an appointment today to come browse our selection and get started with your project. We're committed to working with you one on one, ensuring a customized kitchen design that aligns with your preferences. Additionally, we provide a complimentary quote and 3D renderings."} />
