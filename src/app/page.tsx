  ...
  return (
    <main >
        ...
        <section className='flex flex-col items-left justify-center lg:text-left gap-4 text-center'>
          ...
          <h1 className=' text-2xl lg:text-5xl font-light'>As visionary craftsmen of kitchen elegance based in the heart of New Jersey, our mastery transcends design. 
          Meticulously curating stunning and original kitchen concepts, our goal is to deliver exceptional customer service tailored to your needs. </h1>
        ...
        <section className='flex flex-col items-center justify-center text-center gap-4'>
          ...
          <h1 className=' text-2xl lg:text-5xl font-light'>Uncover the artistry behind our kitchen transformations in the About section <br/> where the journey from concept to creation comes to life</h1>
